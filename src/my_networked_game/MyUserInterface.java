...
import my_networked_game.gameNet.GamePlayer;
import my_networked_game.gameNet.GameNet_UserInterface;
...
public class MyUserInterface extends JFrame implements ActionListener, GameNet_UserInterface
{
	...
	public void startUserInterface (GamePlayer player)
	{
		...
		currentPlayer.setText((playerName==null)?"Your name: ":"Your name: " +playerName+ "");
	...
	public void receivedMessage(Object ob)
	{
	    ...
	    if(ob.toString() != ""){
	    textArea.setText( ob.toString()  +
				lineSeparator + textArea.getText());
	    }
	    ...
	    if(chessGame.getWinner() != null){
			...
			int dialogResult = JOptionPane.showConfirmDialog(null, "Game OVer: " + chessGame.getWinner() + " Win. Exit the Game?", "Game Over", dialogButton);
			if(dialogResult == 0) {
